...
export class EventService {
    ...
    getMessages() {
        return this.http.get('http://www.fourteen76.com/events')
    ...
    getMessagesArts() {
        return this.http.get('http://www.fourteen76.com/events/arts')
              .map((response: Response) => {
                const messages = response.json().obj;
                //v  this transforms the result into what we want on the front end ex: (minus: _v, _id ...)
                let transformedMessages: Message[] = [];
    ...
    getMessagesMusic() {
        return this.http.get('http://www.fourteen76.com/events/music')
              .map((response: Response) => {
                const messages = response.json().obj;
                //v  this transforms the result into what we want on the front end ex: (minus: _v, _id ...)
                let transformedMessages: Message[] = [];
    ...
    getMessagesCommunity() {
        return this.http.get('http://www.fourteen76.com/events/community')
              .map((response: Response) => {
                const messages = response.json().obj;
                //v  this transforms the result into what we want on the front end ex: (minus: _v, _id ...)
                let transformedMessages: Message[] = [];
