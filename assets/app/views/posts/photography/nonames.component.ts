...
export class NoNames implements OnInit {
  ...
  constructor(private titleService: Title, private meta: Meta) {
    this.meta.addTags([
      ...
      {property: 'og:image', content: global.shareImgUrl + 'tyron.jpg'}
      {property: 'og:site_name', content: 'Fourteen76'}
      {name: 'twitter:card', content: 'summary_large_image'},
      {name: 'twitter:title', content: this.postTitle},
      {name: 'twitter:description', content: `Photo Story`},
      {name: 'twitter:image', content: global.shareImgUrl + 'tyron.jpg'}
    ])
  }
  ...
  pageUrl: string = 'NoNames';
  shareTitle: string = 'No%20Names';
  shareFacebook = global.faceShare + this.pageUrl;
  shareTwitter = "";
  hastags = "japan, photostory";
  shareEmail = "";
